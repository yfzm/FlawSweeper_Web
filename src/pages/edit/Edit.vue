...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //                         data = (val === "") ? [] :
            //                             this.tags.filter()
            //                         // this.$Message.success("a+  " + this.value);
            //                     },
            //
            //                 }
            //             })
            ...
            //         onOk: () => {
            //             if (!this.edit_tag) {
            //                 this.$Message.error("未添加标签！");
            //             } else {
            //                 this.$Message.success("添加标签:" + this.edit_tag + " 成功！");
            //
            //                 this.tags.push(this.edit_tag);
            //             }
            //         }
            //     })
            // },
            ...
            modifyItem: function () {
                ...
                // let fd = new FormData;
                // fd.append("id", this.item_id);
                // fd.append("title", this.edit_data.title);
                // fd.append("qText", this.rich_text);
                // fd.append("createTime", (new Date()).getTime().toString());
                // fd.append("reason", this.edit_data.reason);
                // fd.append("cAnswer", this.formValidate.answer);
                // fd.append("qTag", this.edit_data.qTag.toString());
                // console.log(fd);
                ...
                // console.log(encodeURI(encodeURIComponent(data)));
                ...
                xhr.onreadystatechange = () => {
                    ...
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        ...
                        if (registerResponse.status) {
                            ...
                            this.$router.push({name: 'Item', query: {id: this.item_id}});
                        } else {
